            ...
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                    <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                        ...
                        <h3 className="text-black-600 font-poppins " >MetroMinds</h3>

                        <p className="text-base leading-relaxed text-gray-600 mt-7 font-poppins">Building smarter, more resilient cities through innovative urban management solutions.</p>
                    ...
                    <div>
                        <p className="text-sm font-semibold tracking-widest text-gray-400 uppercase font-poppins">Company</p>
                    ...
                    <div>
                        <p className="text-sm font-semibold tracking-widest text-gray-400 uppercase font-poppins">Help</p>
                ...
                <p className="text-sm text-center text-gray-600 font-poppins">© Copyright 2024, All Rights Reserved by Metro-Minds</p>
            </div>
        </section>
